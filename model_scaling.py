...
from biobuddy.model_modifiers.scale_tool import MarkerWeight
...
def main(visualization):
    ...
    osim_filepath = f"/Users/leo/Desktop/Projet/modele_opensim/wu_bras_gauche_seth.osim"
    biomod_filepath = f"/Users/leo/Desktop/Projet/modele_opensim/wu_bras_gauche.bioMod"
    ...
    xml_filepath = f"/Users/leo/Desktop/Projet/Collecte_25_11/Sidonie/scaling.xml"
    scaled_biomod_filepath = f"/Users/leo/Desktop/Projet/modele_opensim/wu_bras_gauche_Sidonie_V3.bioMod"
    static_filepath = f"/Users/leo/Desktop/Projet/Collecte_25_11/C3D_labelled/pos_statique.c3d"
    ...
    scale_tool.add_scaling_segment(
        SegmentScaling(
            ...
            scaling_type=AxisWiseScaling(
                marker_pairs={
                    Translations.X: [["Clav_SC", "Clav_AC"]],
                },
            ),
        )
    )
    ...
    scale_tool.add_scaling_segment(
        SegmentScaling(
            ...
            scaling_type=AxisWiseScaling(
                marker_pairs={
                    Translations.X: [["Scap_AA", "Scap_TS"]],
                    Translations.Y: [["Scap_AA", "Scap_IA"]],
                },
            ),
        )
    )
    ...
    # Scale the model
    static_c3d = C3dData(static_filepath, first_frame=180, last_frame=200)

    scale_tool.marker_weights = {
        name: MarkerWeight(name=name, weight=1.0)
